...
export default {
  ...
  data() {
    return {
      erc20: '0x9802f26c43fd8436ECeE93D8FC5B4C39b39912ff',
      selectedAddress: 'cosmos13nwzm5dfd26ue74jr6sc39gyn3qze0rj8ysze2',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos13nwzm5dfd26ue74jr6sc39gyn3qze0rj8ysze2')
